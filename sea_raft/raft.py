...
# All the parameters are from: https://github.com/princeton-vl/SEA-RAFT/tree/main/config/eval
...
class RaftArgs:
    def __init__(self):
        ...
        self.dim = 128
        self.num_blocks = 2
        self.iters = 1 # how iterations used to estimate the flow
...
class RAFT(
    ...
    def __init__(self, args=RaftArgs()):
        super().__init__()
        self.args = args
